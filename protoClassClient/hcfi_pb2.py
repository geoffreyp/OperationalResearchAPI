...
_INITREQUEST = _descriptor.Descriptor(
  name='InitRequest',
  full_name='hcfi.InitRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer', full_name='hcfi.InitRequest.customer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='solutionSize', full_name='hcfi.InitRequest.solutionSize', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fitness', full_name='hcfi.InitRequest.fitness', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='solution', full_name='hcfi.InitRequest.solution', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='algorithm', full_name='hcfi.InitRequest.algorithm', index=4,
...
try:
  ...
  def beta_create_OperationalResearch_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('hcfi.OperationalResearch', 'InitConversation'): InitRequest.FromString,
      ('hcfi.OperationalResearch', 'SendFitness'): FitnessRequest.FromString,
      ('hcfi.OperationalResearch', 'StopConversation'): StopRequest.FromString,
    }
    response_serializers = {
      ('hcfi.OperationalResearch', 'InitConversation'): FitnessResponse.SerializeToString,
      ('hcfi.OperationalResearch', 'SendFitness'): FitnessResponse.SerializeToString,
      ('hcfi.OperationalResearch', 'StopConversation'): StopResponse.SerializeToString,
    }
    method_implementations = {
      ('hcfi.OperationalResearch', 'InitConversation'): face_utilities.unary_unary_inline(servicer.InitConversation),
      ('hcfi.OperationalResearch', 'SendFitness'): face_utilities.unary_unary_inline(servicer.SendFitness),
      ('hcfi.OperationalResearch', 'StopConversation'): face_utilities.unary_unary_inline(servicer.StopConversation),
    }
  ...
  def beta_create_OperationalResearch_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('hcfi.OperationalResearch', 'InitConversation'): InitRequest.SerializeToString,
      ('hcfi.OperationalResearch', 'SendFitness'): FitnessRequest.SerializeToString,
      ('hcfi.OperationalResearch', 'StopConversation'): StopRequest.SerializeToString,
    }
    response_deserializers = {
      ('hcfi.OperationalResearch', 'InitConversation'): FitnessResponse.FromString,
      ('hcfi.OperationalResearch', 'SendFitness'): FitnessResponse.FromString,
      ('hcfi.OperationalResearch', 'StopConversation'): StopResponse.FromString,
    }
    cardinalities = {
